    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          >
           Quizify is your ultimate tool to create, share, and take interactive quizzes—designed for learning, engagement, and fun. Whether you're an educator, team leader, content creator, or student, Quizify helps you turn knowledge into an exciting experience.
          </motion.p>
